...
async function showText() {
    ...
    let html = `<span class="wrap" style='padding: 24px; background-color: rgb(105, 15, 15); color: white;'>Chúc mừng ngày 20-11</span>`
...
async function typing () {
    const data = [
        "Anh luôn ấn tượng về Thảo Anh</br><span style='font-size: 20px;'>Đã có ai nói với Thảo Anh điều ấy chưa?</span>",
        "Thật đấy!!!: D.", 
        "Thảo Anh có biết Anh muốn nói điều gì không?.",
        "Chúc Thảo Anh luôn xinh đẹp, trẻ trung, hạnh phúc",
        "Khi nào em cần, anh luôn có, khi nào em khó luôn có Anh :))",
